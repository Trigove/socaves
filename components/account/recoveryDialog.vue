  ...
  >
    ...
    >
      <h1
        ...
        v-text="$t('account.email_sent_title')"
      />

      <p
        class="font-extrabold sm:text-xl text-base"
        v-text="$t('account.follow_instructions')"
      />

      <img class="my-5 w-full" width="150" src="~/assets/img/reset.png" />
      ...
      <div class="mb-5">
        ...
        <p
          class="text-xs normal-case mt-1"
 ...
 *  @property {string|false}  canClose Can dialog close or not
 */
export default {
  name: 'RecoveryDialog',
  props: {
